...
export interface FileServerMessage {
  ...
  setMasterKey?: FileServerMessage_SetMasterEncryptionKey | undefined;
  getMasterKey?: FileServerMessage_GetMasterEncryptionKey | undefined;
}
...
export interface FileServerMessage_UploadChunk {
  ...
  chunk: Uint8Array;
  encChunkMetadata: EncryptedChunkMetadata | undefined;
}
...
export interface FileServerMessage_SetMasterEncryptionKey {
  encryptedKey: Uint8Array;
}

export interface FileServerMessage_GetMasterEncryptionKey {
}
...
export interface SetMasterEncryptionKeyResp {
  err?: string | undefined;
}

export interface GetMasterEncryptionKeyResp {
...
export const FileServerMessage = {
  encode(message: FileServerMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.setMasterKey !== undefined) {
      FileServerMessage_SetMasterEncryptionKey.encode(message.setMasterKey, writer.uint32(98).fork()).ldelim();
    }
    if (message.getMasterKey !== undefined) {
      FileServerMessage_GetMasterEncryptionKey.encode(message.getMasterKey, writer.uint32(106).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          message.setMasterKey = FileServerMessage_SetMasterEncryptionKey.decode(reader, reader.uint32());
          continue;
        case 13:
          if (tag !== 106) {
            break;
          ...
          message.getMasterKey = FileServerMessage_GetMasterEncryptionKey.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): FileServerMessage {
    return {
      ...
      getUsageQuery: isSet(object.getUsageQuery)
        ...
        : undefined,
      setMasterKey: isSet(object.setMasterKey)
        ? FileServerMessage_SetMasterEncryptionKey.fromJSON(object.setMasterKey)
        : undefined,
      getMasterKey: isSet(object.getMasterKey)
        ? FileServerMessage_GetMasterEncryptionKey.fromJSON(object.getMasterKey)
        : undefined,
    };
  },
  ...
  toJSON(message: FileServerMessage): unknown {
    ...
    if (message.setMasterKey !== undefined) {
      obj.setMasterKey = FileServerMessage_SetMasterEncryptionKey.toJSON(message.setMasterKey);
    }
    if (message.getMasterKey !== undefined) {
      obj.getMasterKey = FileServerMessage_GetMasterEncryptionKey.toJSON(message.getMasterKey);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FileServerMessage>, I>>(object: I): FileServerMessage {
    ...
    message.getUsageQuery = (object.getUsageQuery !== undefined && object.getUsageQuery !== null)
      ...
      : undefined;
    message.setMasterKey = (object.setMasterKey !== undefined && object.setMasterKey !== null)
      ? FileServerMessage_SetMasterEncryptionKey.fromPartial(object.setMasterKey)
      : undefined;
    message.getMasterKey = (object.getMasterKey !== undefined && object.getMasterKey !== null)
      ? FileServerMessage_GetMasterEncryptionKey.fromPartial(object.getMasterKey)
      : undefined;
    return message;
  },
};
...
function createBaseFileServerMessage_UploadChunk(): FileServerMessage_UploadChunk {
  return { chunkMetadata: undefined, chunk: new Uint8Array(0), encChunkMetadata: undefined };
}
...
export const FileServerMessage_UploadChunk = {
  encode(message: FileServerMessage_UploadChunk, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.encChunkMetadata !== undefined) {
      EncryptedChunkMetadata.encode(message.encChunkMetadata, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.encChunkMetadata = EncryptedChunkMetadata.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): FileServerMessage_UploadChunk {
    return {
      ...
      encChunkMetadata: isSet(object.encChunkMetadata)
        ? EncryptedChunkMetadata.fromJSON(object.encChunkMetadata)
        : undefined,
    };
  },
  ...
  toJSON(message: FileServerMessage_UploadChunk): unknown {
    ...
    if (message.encChunkMetadata !== undefined) {
      obj.encChunkMetadata = EncryptedChunkMetadata.toJSON(message.encChunkMetadata);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FileServerMessage_UploadChunk>, I>>(
    ...
    message.encChunkMetadata = (object.encChunkMetadata !== undefined && object.encChunkMetadata !== null)
      ? EncryptedChunkMetadata.fromPartial(object.encChunkMetadata)
      : undefined;
    return message;
  },
};
...
function createBaseFileServerMessage_SetMasterEncryptionKey(): FileServerMessage_SetMasterEncryptionKey {
  return { encryptedKey: new Uint8Array(0) };
}

export const FileServerMessage_SetMasterEncryptionKey = {
  encode(message: FileServerMessage_SetMasterEncryptionKey, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FileServerMessage_SetMasterEncryptionKey {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFileServerMessage_SetMasterEncryptionKey();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): FileServerMessage_SetMasterEncryptionKey {
    return { encryptedKey: isSet(object.encryptedKey) ? bytesFromBase64(object.encryptedKey) : new Uint8Array(0) };
  },

  toJSON(message: FileServerMessage_SetMasterEncryptionKey): unknown {
    const obj: any = {};
    if (message.encryptedKey.length !== 0) {
  ...
  create<I extends Exact<DeepPartial<FileServerMessage_SetMasterEncryptionKey>, I>>(
    base?: I,
  ): FileServerMessage_SetMasterEncryptionKey {
    return FileServerMessage_SetMasterEncryptionKey.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FileServerMessage_SetMasterEncryptionKey>, I>>(
    object: I,
  ): FileServerMessage_SetMasterEncryptionKey {
    const message = createBaseFileServerMessage_SetMasterEncryptionKey();
...
function createBaseFileServerMessage_GetMasterEncryptionKey(): FileServerMessage_GetMasterEncryptionKey {
  return {};
}

export const FileServerMessage_GetMasterEncryptionKey = {
  encode(_: FileServerMessage_GetMasterEncryptionKey, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): FileServerMessage_GetMasterEncryptionKey {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFileServerMessage_GetMasterEncryptionKey();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): FileServerMessage_GetMasterEncryptionKey {
    return {};
  },

  toJSON(_: FileServerMessage_GetMasterEncryptionKey): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<FileServerMessage_GetMasterEncryptionKey>, I>>(
    base?: I,
  ): FileServerMessage_GetMasterEncryptionKey {
    return FileServerMessage_GetMasterEncryptionKey.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FileServerMessage_GetMasterEncryptionKey>, I>>(
    _: I,
  ): FileServerMessage_GetMasterEncryptionKey {
    const message = createBaseFileServerMessage_GetMasterEncryptionKey();
    return message;
...
function createBaseSetMasterEncryptionKeyResp(): SetMasterEncryptionKeyResp {
  return { err: undefined };
}

export const SetMasterEncryptionKeyResp = {
  encode(message: SetMasterEncryptionKeyResp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.err !== undefined) {
      writer.uint32(10).string(message.err);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SetMasterEncryptionKeyResp {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSetMasterEncryptionKeyResp();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): SetMasterEncryptionKeyResp {
    return { err: isSet(object.err) ? globalThis.String(object.err) : undefined };
  },

  toJSON(message: SetMasterEncryptionKeyResp): unknown {
    const obj: any = {};
    if (message.err !== undefined) {
      obj.err = message.err;
    }
  ...
  create<I extends Exact<DeepPartial<SetMasterEncryptionKeyResp>, I>>(base?: I): SetMasterEncryptionKeyResp {
    return SetMasterEncryptionKeyResp.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SetMasterEncryptionKeyResp>, I>>(object: I): SetMasterEncryptionKeyResp {
    const message = createBaseSetMasterEncryptionKeyResp();
    message.err = object.err ?? undefined;
    return message;
  },
...
function createBaseGetMasterEncryptionKeyResp(): GetMasterEncryptionKeyResp {
  return { encryptedKey: undefined, err: undefined };
}

export const GetMasterEncryptionKeyResp = {
  encode(message: GetMasterEncryptionKeyResp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetMasterEncryptionKeyResp {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetMasterEncryptionKeyResp();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetMasterEncryptionKeyResp {
    return {
      encryptedKey: isSet(object.encryptedKey) ? bytesFromBase64(object.encryptedKey) : undefined,
      err: isSet(object.err) ? globalThis.String(object.err) : undefined,
    };
  },

  toJSON(message: GetMasterEncryptionKeyResp): unknown {
    const obj: any = {};
    if (message.encryptedKey !== undefined) {
      obj.encryptedKey = base64FromBytes(message.encryptedKey);
    }
  ...
  create<I extends Exact<DeepPartial<GetMasterEncryptionKeyResp>, I>>(base?: I): GetMasterEncryptionKeyResp {
    return GetMasterEncryptionKeyResp.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetMasterEncryptionKeyResp>, I>>(object: I): GetMasterEncryptionKeyResp {
    const message = createBaseGetMasterEncryptionKeyResp();
    message.encryptedKey = object.encryptedKey ?? undefined;
    message.err = object.err ?? undefined;
    return message;
  },
};

function createBaseEncryptedChunkMetadata(): EncryptedChunkMetadata {
  return { id: "", encMetadata: new Uint8Array(0) };
}

export const EncryptedChunkMetadata = {
  encode(message: EncryptedChunkMetadata, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.encMetadata.length !== 0) {
      writer.uint32(18).bytes(message.encMetadata);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): EncryptedChunkMetadata {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEncryptedChunkMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): EncryptedChunkMetadata {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      encMetadata: isSet(object.encMetadata) ? bytesFromBase64(object.encMetadata) : new Uint8Array(0),
    };
  },

  toJSON(message: EncryptedChunkMetadata): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
    if (message.encMetadata.length !== 0) {
      obj.encMetadata = base64FromBytes(message.encMetadata);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<EncryptedChunkMetadata>, I>>(base?: I): EncryptedChunkMetadata {
    return EncryptedChunkMetadata.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EncryptedChunkMetadata>, I>>(object: I): EncryptedChunkMetadata {
    const message = createBaseEncryptedChunkMetadata();
    message.id = object.id ?? "";
    message.encMetadata = object.encMetadata ?? new Uint8Array(0);
    return message;
  },
};
